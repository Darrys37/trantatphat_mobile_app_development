// product_data.dart - Shared product & category data
...
const Map<String, Map<String, List<Map<String, dynamic>>>> genderProducts = {
  'Women': {
    ...
    'Crop tops': [
      ...
      {'name': 'Floral Crop',    'brand': 'H&M',             'price': 14, 'oldPrice': null, 'rating': 3.8, 'reviews': 3,  'discount': null, 'isFavorite': true,  'image': 'https://images.pexels.com/photos/1759622/pexels-photo-1759622.jpeg?auto=compress&w=400'},
    ],
    'Sleeveless': [
